...
public class EmployeeValidatorTest {
    ...
    private EmployeeEntityRepository mockEmpRepo;
    private DepartmentRepository mockDeptRepo;
    private CertificationRepository mockCertRepo;
    private EmployeeValidator employeeValidator;

    @BeforeEach
    void setUp() {
        mockEmpRepo = mock(EmployeeEntityRepository.class);
        mockDeptRepo = mock(DepartmentRepository.class);
        mockCertRepo = mock(CertificationRepository.class);
        employeeValidator = new EmployeeValidator(mockEmpRepo, mockDeptRepo, mockCertRepo);
    }
    ...
    void testValidateAddEmployeeSuccessWithoutCertifications() {
        ...
        MessageResponse error = employeeValidator.validateAddEmployee(request);
    ...
    void testValidateEmployeeId() {
        ...
        MessageResponse errorNull = employeeValidator.validateEmployeeId(null);
        assertNotNull(errorNull);
        assertEquals(Constants.ERROR_CODE_ER001, errorNull.getCode());
        assertEquals(List.of(Constants.PARAM_ID), errorNull.getParams());

        // 2. employeeId <= 0 -> ER001
        MessageResponse errorNegative = employeeValidator.validateEmployeeId(0L);
        assertNotNull(errorNegative);
        ...
        MessageResponse errorNotFound = employeeValidator.validateEmployeeId(999L);
        ...
        MessageResponse valid = employeeValidator.validateEmployeeId(1L);
        assertNull(valid);
    }
    ...
    void testValidateEmployeeIdForDelete() {
        // 1. employeeId null -> ER001
        MessageResponse errorNull = employeeValidator.validateEmployeeIdForDelete(null);
        assertNotNull(errorNull);
        assertEquals(Constants.ERROR_CODE_ER001, errorNull.getCode());
        assertEquals(List.of(Constants.PARAM_ID), errorNull.getParams());

        // 2. employeeId <= 0 -> ER001
        MessageResponse errorNegative = employeeValidator.validateEmployeeIdForDelete(0L);
        assertNotNull(errorNegative);
        assertEquals(Constants.ERROR_CODE_ER001, errorNegative.getCode());
        assertEquals(List.of(Constants.PARAM_ID), errorNegative.getParams());
        ...
        MessageResponse errorNotFound = employeeValidator.validateEmployeeIdForDelete(999L);
        assertNotNull(errorNotFound);
        assertEquals(Constants.ERROR_CODE_ER014, errorNotFound.getCode());
        assertEquals(List.of(Constants.PARAM_ID), errorNotFound.getParams());

        // 4. employeeId tồn tại nhưng có role là ADMIN -> ER020 (không được xóa role Admin)
        ...
        MessageResponse errorAdmin = employeeValidator.validateEmployeeIdForDelete(2L);
        assertNotNull(errorAdmin);
        assertEquals(Constants.ERROR_CODE_ER020, errorAdmin.getCode());
        assertEquals(List.of(), errorAdmin.getParams());
        ...
        MessageResponse valid = employeeValidator.validateEmployeeIdForDelete(1L);
        assertNull(valid);
    }
    ...
    void testValidateUpdateEmployeeSuccess() {
        ...
        MessageResponse error = employeeValidator.validateUpdateEmployee(request);
        assertNull(error);
    }
